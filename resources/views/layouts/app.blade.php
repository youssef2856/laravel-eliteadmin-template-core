...
<body class="skin-blue fixed-layout">
    ...
    <div id="main-wrapper">
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="element {{preg_match('/home/',\Request::route()->getName()) ? 'active' : ''}}"> <a class="waves-effect waves-dark {{preg_match('/home/',\Request::route()->getName()) ? 'active' : ''}}" href="{{route('home')}}" aria-expanded="false">
        ...
        <!-- ============================================================== -->
        <footer class="footer">
            &copy;<script>document.write(new Date().getFullYear())</script>&nbsp;<a href="#" target="_blank">Youssef Chartaoui.</a>
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
